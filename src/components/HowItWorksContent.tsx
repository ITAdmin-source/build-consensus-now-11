...
export const HowItWorksContent: React.FC<HowItWorksContentProps> = ({ showCard = true }) => {
  ...
  if (showCard) {
    return (
      <div className="max-w-5xl mx-auto shadow-xl border-2 border-gray-100 bg-white rounded-lg">
        {content}
      </div>
    );
  }
