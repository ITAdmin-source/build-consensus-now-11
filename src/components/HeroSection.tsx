...
export const HeroSection: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-r from-[#1a305b] via-[#ec0081] to-[#66c8ca] text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 text-center relative z-10">
        ...
        <div className="space-y-4 mb-8">
          <p className="text-xl md:text-2xl font-semibold hebrew-text leading-relaxed text-yellow-100">
