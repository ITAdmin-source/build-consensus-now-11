  ...
  return (
    <div className="relative bg-gradient-to-br from-[#1a305b] via-[#2a4a7b] to-[#1a305b] text-white overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 py-16 text-center relative z-10">
        ...
        {/* Enhanced main title */}
        <h1 className="text-5xl md:text-7xl font-bold mb-8 hebrew-text relative">
        ...
        <div className="space-y-6 mb-12">
          <div className="relative">
            <p className="text-2xl md:text-3xl font-bold hebrew-text leading-relaxed text-[#66c8ca] drop-shadow-lg">
              🎮 שחקו ברצינות - בנו הסכמה אמיתית 🏆
            </p>
            <div className="absolute -inset-2 bg-[#66c8ca]/20 blur-lg rounded-lg opacity-30"></div>
          </div>
          <p className="text-lg md:text-xl opacity-90 max-w-4xl mx-auto hebrew-text leading-relaxed font-medium">
